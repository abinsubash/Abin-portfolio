...
const Footer = () => {
  const socialLinks = [
    { 
      ...
      link: "https://github.com/abinsubash",
      name: "GitHub"
    },
    { 
      icon: <FaLinkedin className="w-6 h-6" />, 
      link: "https://www.linkedin.com/in/abin-subash-59b2232ab/",
      name: "LinkedIn"
    },
    { 
      icon: <FaTwitter className="w-6 h-6" />, 
      link: "https://x.com/AbinSubashkk",
      name: "Twitter"
    },
    { 
      icon: <FaInstagram className="w-6 h-6" />, 
      link: "https://www.instagram.com/abin__subash/",
      name: "Instagram"
    }
  ]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} Abin Subash. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
